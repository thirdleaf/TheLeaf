    ...
    <div className="min-h-screen bg-[#050508] text-white">
      ...
      <main className="pt-32 pb-24 px-6 max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert prose-zinc max-w-none text-zinc-400 space-y-12">
           ...
           <section className="space-y-6">
              <h2 className="text-2xl font-black text-white">2. Nature of the Service (Non-Advisory)</h2>
              <p>
                ThirdLeaf is a SaaS platform providing post-trade analytics, journaling, and performance visualization. 
                <strong className="text-white">ThirdLeaf is NOT a SEBI-registered Investment Advisor (RIA) or Research Analyst.</strong>
              </p>
           ...
           <section className="space-y-6">
              <h2 className="text-2xl font-black text-white">3. Subscription, Payments & Refunds</h2>
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-sm">
                  <li><strong className="text-white">Auto-Renewal:</strong> Subscriptions provided as monthly or annual plans will auto-renew unless canceled 24 hours prior to the next billing cycle.</li>
                  <li><strong className="text-white">No-Refund Policy:</strong> Due to the digital nature of our performance analytics and the instant availability of historical sync features, we do not offer refunds once a trade sync has been performed.</li>
                  <li><strong className="text-white">Cancellation:</strong> You may cancel your subscription at any time via the Settings dashboard. Access will remain until the end of the current billing period.</li>
                </ul>
              </div>
           </section>

           <section className="space-y-6">
              <h2 className="text-2xl font-black text-white">4. Platform Usage & Integrity</h2>
           ...
           <section className="space-y-6">
              <h2 className="text-2xl font-black text-white">6. Jurisdiction</h2>
              <p>
                These Terms are governed by the laws of India. Any legal action or proceeding relating to your access to, or use of, the platform shall be instituted in a state or federal court in <strong className="text-white">Bengaluru, Karnataka</strong>.
              </p>
           </section>
        </div>
