      ...
      <main className="pt-32 pb-24 px-6 max-w-3xl mx-auto">
        ...
        <div className="prose prose-zinc dark:prose-invert max-w-none text-text-secondary space-y-12">
           <section className="space-y-6">
              <h2 className="text-2xl font-black text-text-primary">1. Introduction & Scope</h2>
              <p>
                ThirdLeaf Technologies Pvt. Ltd. (&quot;ThirdLeaf&quot;, &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) operates the ThirdLeaf platform. This Privacy Policy is designed to comply with the <strong className="text-text-primary">Digital Personal Data Protection (DPDP) Act, 2023</strong> of India and other global data protection standards. We are committed to transparency in how we handle the sensitive trading data of our users.
              </p>
           </section>

           <section className="space-y-6">
              <h2 className="text-2xl font-black text-text-primary">2. Data We Collect and Why</h2>
              <div className="space-y-4">
                <h3 className="text-lg font-bold text-text-primary">2.1 Personal Identifiable Information (PII)</h3>
                ...
                <h3 className="text-lg font-bold text-text-primary">2.2 Financial & Brokerage Data</h3>
                <p>When you link your broker accounts via OAuth or API Secrets, we collect historical order logs, trade executions, and position data. <strong className="text-text-primary">We do NOT have access to your funds, nor can we initiate withdrawals or transfers on your behalf.</strong> This data is used strictly to populate your journaling dashboards.</p>
                
                <h3 className="text-lg font-bold text-text-primary">2.3 Behavioral & Mindset Data</h3>
           ...
           <section className="space-y-6 p-8 bg-accent/5 border border-accent/10 rounded-[40px] relative overflow-hidden">
           ...
           <section className="space-y-6">
              <h2 className="text-2xl font-black text-text-primary">3. Cookies and Tracking</h2>
              <p>
           ...
           <section className="space-y-6">
              <h2 className="text-2xl font-black text-text-primary">4. Data Retention and Deletion</h2>
              <p>
                We retain your data as long as your account is active. Upon request for account deletion, all PII and brokerage data are purged from our primary databases within <strong className="text-text-primary">72 hours</strong>. Backup archives may retain data for up to 30 days before full rotation/deletion.
              </p>
           </section>

           <section className="space-y-6">
              <h2 className="text-2xl font-black text-text-primary">5. Third-Party Services</h2>
              <p>
                We share data only with necessary service providers:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-sm text-text-secondary">
                <li><strong className="text-text-primary">Clerk:</strong> For identity and session management.</li>
                <li><strong className="text-text-primary">Neon/AWS:</strong> For secure, encrypted database storage.</li>
                <li><strong className="text-text-primary">Official Broker APIs:</strong> (Zerodha, Dhan, etc.) For trade synchronization.</li>
              </ul>
           </section>

           <section className="space-y-6">
              <h2 className="text-2xl font-black text-text-primary">6. Contact Data Protection Officer</h2>
              <p>
                If you have concerns about your data privacy or wish to exercise your rights under the DPDP Act, please contact our Grievance Officer at <strong className="text-accent">privacy@thirdleaf.com</strong>.
              </p>
           </section>
        </div>
